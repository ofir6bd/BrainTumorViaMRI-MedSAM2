...
For each sample patient, detect the **whole tumor** from **FLAIR intensity clustering** in
the skull-stripped image, then score the result against the ground
...
### Stage B — Per-slice FCM segmentation processing (on FLAIR)
